...
const char* userId = "kitchen";           //유저 아이디
...
char* topic_K = "Smart/Myhome/IOT/LampSwitch/kitchen";
char* topic_V = "Smart/Myhome/IOT/LampSwitch/back_veranda";
char* topic_AppK = "Smart/Myhome/App/LampSwitch/kitchen";
char* topic_AppV = "Smart/Myhome/App/LampSwitch/back_veranda";
...
void Pub_msg(String pub_value, int pub_topic){
  ...
  if(pub_topic == 0){
    Serial.println(String(topic_AppK) + " : " + buf);
    client.publish(topic_AppK, buf);
  }
  else if(pub_topic == 1){
