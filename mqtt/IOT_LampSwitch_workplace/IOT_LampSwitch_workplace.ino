...
const char* userId = "workplace";           //유저 아이디
...
char* topic_W= "Smart/Myhome/IOT/LampSwitch/workplace";
char* topic_AppW = "Smart/Myhome/App/LampSwitch/workplace";
...
void Pub_msg(String pub_value){
  ...
  Serial.println(String(topic_AppW) + " : " + buf);
  client.publish(topic_AppW, buf);
}
